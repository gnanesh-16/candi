...
import require$$1$6, { app, BrowserWindow } from "electron";
...
function requireAppUpdater() {
  ...
  class AppUpdater2 extends events_12.EventEmitter {
    /**
...
function createWindow() {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    const indexHtml = path$i.join(RENDERER_DIST, "index.html");
